  ...
  return (
    <div>
      <Routes>
        ...
        {/* 2. PHYSICAL REQUEST FORM */}
        <Route path="/request" element={<RequestForm />} />

        {/* 3. DIGITAL LETTER CREATOR (NEW) */}
...
function LandingPage() {
  ...
  async function checkTicket() {
    ...
    // 2. If not found, Check DIGITAL Letters
    // (Note: We will build the View Page next, for now just show "Found")
    ...
    if (digitalData) {
      // If found, we will eventually navigate to the viewer
      alert("Digital Letter Found! (Viewer coming in next update)") 
      // navigate(`/view/${ticketInput.toUpperCase()}`) <-- We will uncomment this later
    } else {
      ...
      <div style={styles.card}>
        ...
        <div style={styles.contactSection}>
          ...
          <a href="/request" style={{ textDecoration: 'none' }}>
            <button style={styles.requestBtn}>✍️ Request Physical Letter</button>
          </a>
          
          {/* NEW BUTTON FOR DIGITAL LETTER */}
          <a href="/create" style={{ textDecoration: 'none' }}>
            <button style={{...styles.requestBtn, background: 'white', color: '#2d3436', border: '2px solid #2d3436', marginTop: '10px'}}>
              💌 Make Digital Letter
            </button>
          </a>
          ...
          <div style={styles.socialLinks}>
            <a href="https://facebook.com/calebragx" target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
              <button style={{...styles.socialBtn, background: '#1877F2'}}>
                <svg viewBox="0 0 24 24" width="24" height="24" style={{ marginRight: '10px', fill: 'white' }}><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg> Caleb Ragx
              </button>
            </a>
